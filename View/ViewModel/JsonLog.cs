...
public class JsonLog
{
    ...
    [JsonProperty("EncryptTime")]
    private string EncryptTime {get; set; }

    public JsonLog(string? name, string fileSource, string? fileTarget, string? destPath, string fileSize, string fileTransferTime, string time, string encryptTime)
    {
        Name = name;
